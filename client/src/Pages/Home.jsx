      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .theme-btn {
          ...
          font-size: 1.15rem; transition: all 0.25s;
        }
        ...
        .logo-text {
          ...
          line-height: 0.95; color: var(--text); text-align: center;
        }
        ...
        .prefix {
          padding: 0.95rem 1.1rem; font-size: 0.8rem;
          color: var(--text-muted); border-right: 1px solid var(--border);
          white-space: nowrap; display: flex; align-items: center;
          background: var(--bg2); transition: background 0.35s; user-select: none;
        }

        .slug-input {
          flex: 1; min-width: 0; padding: 0.95rem 1.1rem;
        ...
        .go-btn {
          ...
          color: var(--accent-text); transition: background 0.2s, transform 0.1s;
          white-space: nowrap;
        }
        ...
        .qs {
          ...
          border-radius: 999px; font-size: 0.67rem;
